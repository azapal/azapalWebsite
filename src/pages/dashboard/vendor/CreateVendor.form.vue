...
const vendorCreationStage = ref('1')


const handleLocation = (event) => {
  createBusinessModel.value.location = event.latitude+', '+event.longitude;
  vendorCreationStage.value = '2'
...
const submitBusinessForm = async () => {
  loading.value = true;
  createBusinessModel.value.category = 'seller'
