...
const product = ref({
  name: 'Azapal Cooperatives',
  tagline: 'Secure financial community service',
  description: 'Azapal Cooperatives is a managed community cooperative dedicated to instil discipline and growth, weather' +
      ' you are an individual or a SME business owner',
  pricing: {
    cost: 'free',
    storage: null,
    trial: null,
